  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        ...
        <h1
          className="text-4xl md:text-5xl font-semibold text-white mb-4 opacity-0 animate-fade-in"
          style={{ fontFamily: 'Poppins, serif', animationDelay: "0.2s" }}
        >
          Jelajahi <span className="text-[#E9CBA7]">Minuman Segar</span>
        </h1>
        ...
        >
          Temukan berbagai minuman menyegarkan dari klasik hingga modern.  
          <span className="text-[#E9CBA7] font-semibold"> Segarkan harimu.</span>
        </p>
        ...
        >
          <input
            ...
            className="px-6 py-3 w-full bg-transparent text-[#2f4a57] outline-none text-lg"
            style={{ fontFamily: 'Georgia, serif' }}
          />
          <button
            className="px-8 bg-[#6E4A3E] text-white font-semibold hover:bg-[#233b45] transition-all text-lg"
